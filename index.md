...
Контрол "Таблица" (Controls.grid:View) является компонентом, обеспечивающим представление данных в виде таблицы с поддержкой широкого набора возможностей, таких как сортировка, фильтрация, редактирование, настройка колонок и т.д. Данный контрол является частью фреймворка Wasaby и активно используется в построении сложных пользовательских интерфейсов, работающих с большими объемами структурированных данных.
